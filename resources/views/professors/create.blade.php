...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Create Professor</h1>
    <form action="{{ route('professors.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Professor</button>
            </div>
        </div>
    </form>
</div>
