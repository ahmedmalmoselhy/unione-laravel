...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Create Class</h1>
    <form action="{{ route('classes.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="code" id="code" value="{{ old('code') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="academic_year" id="academic_year" value="{{ old('academic_year', date('Y')) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="capacity" id="capacity" value="{{ old('capacity', 30) }}" required min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Class</button>
            </div>
        </div>
    </form>
</div>
