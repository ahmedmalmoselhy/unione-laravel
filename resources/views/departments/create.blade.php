...
<div class="max-w-2xl">
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">Add a new department to the system</p>
    </div>

    <form action="{{ route('departments.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Department</button>
            </div>
        </div>
    </form>
</div>
