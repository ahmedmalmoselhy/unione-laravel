...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Create Subject</h1>
    <form action="{{ route('subjects.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        @csrf
        <div class="space-y-6">
            <div>
            ...
            <div>
                ...
                <input type="number" name="credits" id="credits" value="{{ old('credits', 0) }}" required min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Subject</button>
            </div>
        </div>
    </form>
</div>
